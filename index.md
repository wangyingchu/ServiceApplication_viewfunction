...
ViewFUNCTION 智慧协作管理平台用户客户端程序是一套使用***Javascript***技术开发的Web应用程序。它是企业的业务人员在日常的业务工作中使用的主要工具，具有以下主要业务功能：
...
◼︎ 下图为预览图片格式文件界面：
![预览图片格式文件界面](pic/vf12.png)

◼︎ 下图为预览PDF格式文件界面：
![预览PDF格式文件界面](pic/vf13.png)
